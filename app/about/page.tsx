...
const BUSINESS_PROBLEMS = [
  ...
  "Проекты движутся, но результат теряется между задачами, встречами и согласованиями.",
    ...
    <div className="space-y-10">
        ...
        <div className="relative grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-[62ch] text-base leading-8 text-white/72 md:text-lg">
              ...
              нужно не больше активности, а более управляемая система: ясные цели, сильные решения,
              прозрачная ответственность и изменения, которые не растворяются после запуска.
            </p>
      ...
      <section className="grid gap-5 lg:grid-cols-[0.9fr_1.1fr]">
        <article className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft md:p-8">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-900 md:text-4xl">
            Практик, который смотрит на систему, а не только на список задач
          </h2>
          <p className="mt-4 text-base leading-8 text-slate-700">
            Моя работа находится на стыке управления, изменений, проектного офиса, Agile, OKR,
            ИИ и развития руководителей. Я помогаю увидеть, где бизнес теряет скорость,
            управляемость и результат, а затем собрать контур действий, который можно внедрять.
          </p>
          <p className="mt-4 text-base leading-8 text-slate-700">
            Этот сайт не про резюме и не про набор регалий. Он про способ мышления: как смотреть на
            компанию как на систему, находить настоящие ограничения и проводить изменения без хаоса.
          </p>
        </article>
        ...
        <article className="rounded-[2rem] border border-[#f1d973] bg-[#fff9d4] p-6 shadow-soft md:p-8">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-900 md:text-4xl">
            Ситуации, где моя оптика особенно полезна
          </h2>
      ...
      <section className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-soft md:p-8">
        ...
        <h2 className="mt-3 max-w-[18ch] text-3xl font-black tracking-tight text-slate-900 md:text-5xl">
          Сначала понять систему, потом выбирать инструменты
        </h2>
        <p className="mt-4 max-w-4xl text-base leading-8 text-slate-700 md:text-lg">
          Я не начинаю с модных практик. Сначала нужно понять контекст: где бизнес хочет расти,
          что мешает результату, как принимаются решения, где застревают процессы, продажи,
          люди и управление. Только после этого есть смысл выбирать инструмент: Agile, OKR,
          проектный контур, ИИ, обучение или консалтинг.
        </p>
      ...
      <section className="space-y-5">
        <div>
          ...
          <h2 className="mt-2 text-4xl font-black tracking-tight text-slate-900">
            Темы, где я соединяю практику и систему
          </h2>
        </div>
      ...
      <section className="grid gap-5 lg:grid-cols-2">
        <article className="rounded-[2rem] border border-[#95dff5] bg-[linear-gradient(135deg,#eaf8ff_0%,#f7fbff_100%)] p-6 shadow-soft md:p-8">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-900">
            Когда нужно спокойно собрать базу
          </h2>
          <p className="mt-4 text-base leading-8 text-slate-700">
            Курсы помогают разложить по полкам управленческое мышление, проектный подход, Agile,
            ИИ, цифровые продукты и работу с изменениями. Это формат не для вдохновения на вечер,
            а для спокойной сборки навыка.
          </p>
          <Link
            href={STEPIK_TEACH_URL}
            target="_blank"
        ...
        <article className="rounded-[2rem] border border-[#efb8d2] bg-[linear-gradient(135deg,#fff0f7_0%,#fff8e8_100%)] p-6 shadow-soft md:p-8">
          ...
          <h2 className="mt-3 text-3xl font-black tracking-tight text-slate-900">
            Когда нужно разобрать конкретный узел
          </h2>
          <p className="mt-4 text-base leading-8 text-slate-700">
            Консалтинг полезен, когда есть управленческий узел: рост буксует, проекты теряют
            результат, изменения не закрепляются, команда перегружена или ИИ нужно встроить
            в работу без лишнего шума.
          </p>
          <Link
            href={TELEGRAM_CONSULT_URL}
            target="_blank"
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-[64ch] text-base leading-8 text-slate-700">
              Можно начать со статей и диагностик, читать короткие заметки в Telegram, пройти курс
              или принести на разбор конкретную ситуацию из компании.
            </p>
          </div>
