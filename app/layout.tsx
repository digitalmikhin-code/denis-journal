...
export default function RootLayout({
  ...
  return (
    <html lang="ru">
      <body>
        <Script id="yandex-metrika-init" strategy="beforeInteractive" dangerouslySetInnerHTML={{ __html: `
          ...
          ym(${YANDEX_METRIKA_ID},"init",{defer:true,webvisor:true,clickmap:true,trackLinks:true,accurateTrackBounce:true,ecommerce:"dataLayer"});
        ` }} />
