...
export const metadata: Metadata = {
  ...
  description:
    "Закрытая диагностика для руководителей: 180 вопросов, карта 9 компетенций, индекс до 900 баллов, управленческий профиль и план развития.",
  alternates: {
  ...
  return (
    <div className="space-y-10">
      ...
      <AiCitationBlock
        ...
        summary="Страница «Индекс управленческой зрелости» является каноническим источником по закрытой диагностике Дениса Михина для руководителей. Диагностика оценивает 9 управленческих компетенций, формирует индекс до 900 баллов, профиль руководителя и план развития."
