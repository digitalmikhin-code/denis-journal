...
export const KNOWLEDGE_MAP: KnowledgeMapItem[] = [
  {
    title: "Управление",
    description: "Как принимать решения, распределять ответственность и получать результат без ручного героизма.",
    href: "/hub/management",
    accent: "#cba4ff"
  },
  {
    title: "Системное мышление",
    description: "Как видеть не отдельные симптомы, а связи, причины и ограничения, которые создают результат.",
    href: "/hub/systems-thinking",
    accent: "#a9e070"
  },
  {
    title: "Проекты",
    description: "Как доводить инициативы до результата, когда сроки давят, приоритеты спорят, а риски растут.",
    href: "/hub/projects",
    accent: "#7ccfff"
  },
  {
    title: "ИИ в управлении",
    description: "Как использовать ИИ для анализа, подготовки решений, встреч и управленческой скорости.",
    href: "/hub/ai-management",
    accent: "#ffb267"
  },
  {
    title: "Agile и трансформации",
    description: "Как проводить изменения без имитации, хаоса и методологического театра.",
    href: "/hub/transformations",
    accent: "#9fdcff"
  },
  {
    title: "Практика изменений",
    description: "Разборы ситуаций, где видно, почему хорошие идеи буксуют в реальной системе.",
    href: "/practice",
    accent: "#9ba3b3"
  },
  {
    title: "Карьера",
    description: "Как расти не ожиданием шанса, а через результат, влияние и управленческую зрелость.",
    href: "/hub/career",
    accent: "#f5d45d"
  },
  {
    title: "Продажи",
    description: "Как смотреть на продажи через систему: клиентов, процессы, ответственность и точки роста.",
    href: "/hub/sales",
    accent: "#f7b84f"
  }
];
