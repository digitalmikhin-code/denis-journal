...
export const AUTHOR_ENTITY = {
  ...
  shortDescription:
    "Денис Михин — HR-консультант, Head of HR PMO, практик управления изменениями, автор экспертного журнала и курсов. Помогает бизнесу с HR по подписке, управлением командами, проектами и применением ИИ.",
  extendedDescription:
